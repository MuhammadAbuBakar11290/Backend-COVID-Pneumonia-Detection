...
# Load the models with compile=False to avoid any issues related to compilation
...
covid_model = load_model(covid_model_path, compile=False)
pneumonia_model = load_model(pneumonia_model_path, compile=False)
validation_model = load_model(validation_pipeline_path, compile=False)
